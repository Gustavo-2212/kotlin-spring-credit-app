...
import edu.dio.credit.app.system.dto.Credit.CreditView
import edu.dio.credit.app.system.dto.Credit.CreditViewList
...
class CreditController(
    ...
    fun saveCredit(@RequestBody @Valid creditDto: CreditDTO): ResponseEntity<String> {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body( "Credit ${credit.creditCode} - ${credit.customer?.firstName} saved!" )
    }
